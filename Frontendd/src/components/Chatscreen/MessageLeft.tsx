...
function ResultRowsNlPreview({
  ...
  return (
    <div className="mt-3 rounded-lg border border-gray-100 bg-gray-50/60 px-3 py-2.5 text-sm text-gray-800">
      <p className="m-0 mb-2 text-xs font-medium text-gray-500">
        Row-by-row view — full spreadsheet: use <span className="font-semibold text-gray-700">Download CSV</span>{' '}
        below.
      </p>
